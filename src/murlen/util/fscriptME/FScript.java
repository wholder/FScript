...
public class FScript {
   ...
   */
  protected Object callFunction (String name, List<Object> params) throws FSException {
    throw new FSException("Unrecognized External: " + name);
  }
  ...
  public final Object callScriptFunction (String name, List<Object> params) throws FSException {
